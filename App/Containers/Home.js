...
class Home extends Component {
  ...
  popUp = () => {
    Alert.alert('Please Select Your Language', '', [
    ...
    return (
      <View style={styles.mainBackgroud}>
        <View style={styles.startTextViewStyle}>
          <Text style={styles.titleStyle}>{strings.welcome_to}</Text>
        </View>
        ...
        <View style={styles.startTextViewStyle}>
          <Text style={styles.startTextStyle}>{strings.press_get_started_to_begin}</Text>
        </View>
        <View style={styles.cathyViewStyle}>
          <Image style={styles.cathyImageStyle} source={require('../../resources/cathy.png')} />
        </View>
        <Button
        ...
        <View style={styles.disclaimerTextViewStyle}>
          <Text
            ...
            onPress={this.onPressDisclaimer}
          >
